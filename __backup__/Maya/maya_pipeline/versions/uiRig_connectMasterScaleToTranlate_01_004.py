...
def buildWindow(inj, windowName, windowTitle, line00, line01, line02):
	...
	cmd2 = inj + '.ui_getSetSelectDestination("' + windowName + '","textFieldButtonGrp")'
...
def runWindow(windowName):
	...
	#destCntrl = destCtrlArray[0]
	#print( "destCntrl = " + str(destCntrl) )
...
print("line 0215 :: Imported uiRig_connectMasterScaleToTranlate Module")