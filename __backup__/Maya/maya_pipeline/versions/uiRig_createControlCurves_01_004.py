...
line_12 = 'TYPE IN ONE OF THE FOLLOWING: IK,  FK,  SplineIK,  Cloth,  Face,  OR  Misc'


ver = ' : ver 01.004 ' # This needs to be updated each time the script is updated or modified.
comment = 'Adding Custom radio buttons for Solver Types.'
...
def buildWindow(thisModule,uiModule,windowName,windowTitle, line01, line02, line03, line04, line05, line06, line07, line08, line09, line10, line11):
	...
	maya.cmds.rowLayout( windowName + '_row1_15a', numberOfColumns=1, columnWidth2=(450, 20), adjustableColumn=1, columnAlign=(1, 'left'))
	...
	maya.cmds.text( windowName + '_descip1_16a', label= line01, height=questionButtonHeight, align=textAlign )
	maya.cmds.text( windowName + '_space1_16a', label='', height=questionButtonHeight)
	maya.cmds.setParent('..')
